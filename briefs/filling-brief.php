	<section class="brief section-dark" id="brief">
		<div class="container">
			...
			<form class="quiz-form" id="quizForm" novalidate>
				...
				<div class="quiz-success hidden" id="quizSuccess"><img src="/img/svg/like.svg" alt="Заявка отправлена"><h3>Спасибо!</h3><p>Мы свяжемся и рассчитаем стоимость наполнения.</p></div>
			</form>
		</div>
