	<section class="brief section-dark" id="brief">
		<div class="container">
			...
			<form class="quiz-form" id="quizForm" novalidate>
				...
				<div class="quiz-success hidden" id="quizSuccess"><img src="/img/svg/like.svg" alt=""><h3>Спасибо!</h3><p>Мы свяжемся и подготовим предложение по вашему корпоративному сайту.</p></div>
			</form>
		</div>
